...
func CreatedBy(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedBy(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByEQ(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedBy), v))
	})
}
...
func CreatedByNEQ(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByIn(vs ...int) predicate.Status {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedByNotIn(vs ...int) predicate.Status {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedByGT(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByGTE(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByLT(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByLTE(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByIsNil() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func CreatedByNotNil() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByEQ(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdatedBy), v))
	})
}
...
func UpdatedByNEQ(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByIn(vs ...int) predicate.Status {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedByNotIn(vs ...int) predicate.Status {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedByGT(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByGTE(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByLT(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByLTE(v int) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByIsNil() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func UpdatedByNotNil() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
...
func HasActors() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ActorsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ActorsTable, ActorsColumn),
		)
...
func HasActorsWith(preds ...predicate.Actor) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasReactedActors applies the HasEdge predicate on the "reacted_actors" edge.
func HasReactedActors() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ReactedActorsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, ReactedActorsTable, ReactedActorsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasReactedActorsWith applies the HasEdge predicate on the "reacted_actors" edge with a given conditions (other predicates).
func HasReactedActorsWith(preds ...predicate.Actor) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ReactedActorsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, ReactedActorsTable, ReactedActorsPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasReactions() predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasReactionsWith(preds ...predicate.Reaction) predicate.Status {
	return predicate.Status(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
